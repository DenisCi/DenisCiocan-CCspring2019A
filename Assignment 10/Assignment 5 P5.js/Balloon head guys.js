//Assignment 5 redone in p5.js

var posx = 700;    //initial x position of first guy
var posy = 800;    //initial y position of first guy
var radius = 200;  //radius of guy1's head
var speedx = 0;    //movement in x
var step = .5;     //speed of inflation

function setup(){
createCanvas(1920, 1080);//canvas size
background(70, 120, 240) //blue sky bg
}
...
function draw(){
    ...
    rect(1920/2, 1080, 1920, 1080); //draws grassy area 

    //drawing guys and using functions
...
function drawGuy(posx, posy, headsize, weight){
